...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{head}\NormalTok{(corr}\SpecialCharTok{$}\NormalTok{cor,}\DecValTok{2}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{07-unsupML_files/figure-latex/unnamed-chunk-7-1.pdf}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mat }\OtherTok{\textless{}{-}}\NormalTok{ corr}\SpecialCharTok{$}\NormalTok{cor}
...
\NormalTok{p\_values }\OtherTok{\textless{}{-}} \FunctionTok{ifelse}\NormalTok{(corr}\SpecialCharTok{$}\NormalTok{p\_adj}\SpecialCharTok{\textless{}}\NormalTok{p\_threshold, }\StringTok{"X"}\NormalTok{, }\StringTok{""}\NormalTok{)}

\FunctionTok{pheatmap}\NormalTok{(mat,}
         \AttributeTok{breaks =}\NormalTok{ breaks,}
         \AttributeTok{color =}\NormalTok{ colors,}
         \AttributeTok{display\_numbers =}\NormalTok{ p\_values,}
...
\includegraphics{07-unsupML_files/figure-latex/unnamed-chunk-8-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{set.seed}\NormalTok{(}\DecValTok{19574}\NormalTok{)}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Convert boolean values into numeric}
\NormalTok{bicluster\_columns[ , }\DecValTok{1}\NormalTok{] }\OtherTok{\textless{}{-}} \FunctionTok{as.numeric}\NormalTok{(bicluster\_columns[ , }\DecValTok{1}\NormalTok{])}
\NormalTok{bicluster\_rows[ , }\DecValTok{1}\NormalTok{] }\OtherTok{\textless{}{-}} \FunctionTok{as.numeric}\NormalTok{(bicluster\_rows[ , }\DecValTok{1}\NormalTok{])}
...
\includegraphics{07-unsupML_files/figure-latex/unnamed-chunk-17-1.pdf}
...
\includegraphics{07-unsupML_files/figure-latex/unnamed-chunk-18-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{butyrate\_cutoff }\OtherTok{\textless{}{-}} \FunctionTok{median}\NormalTok{(butyrate\_df\_train}\SpecialCharTok{$}\NormalTok{Butyrate)}
