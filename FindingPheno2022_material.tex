...
\NormalTok{cran\_pkg }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\StringTok{"BiocManager"}\NormalTok{, }\StringTok{"bookdown"}\NormalTok{, }\StringTok{"dplyr"}\NormalTok{, }\StringTok{"ecodist"}\NormalTok{, }\StringTok{"ggplot2"}\NormalTok{, }
              ...
              \StringTok{"ranger"}\NormalTok{, }\StringTok{"stringr"}\NormalTok{, }\StringTok{"pheatmap"}\NormalTok{, }\StringTok{"patchwork"}\NormalTok{, }\StringTok{"pdp"}\NormalTok{, }\StringTok{"biclust"}\NormalTok{)}
\NormalTok{bioc\_pkg }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\StringTok{"mia"}\NormalTok{, }\StringTok{"miaViz"}\NormalTok{, }\StringTok{"microbiomeDataSets"}\NormalTok{)}
...
\includegraphics{06-unsupML_files/figure-latex/unnamed-chunk-9-1.pdf}
...
\includegraphics{07-supML_files/figure-latex/unnamed-chunk-5-1.pdf}
...
\includegraphics{07-supML_files/figure-latex/unnamed-chunk-6-1.pdf}
...
\CommentTok{\# Calculate and plot partial dependence}
...
\includegraphics{07-supML_files/figure-latex/unnamed-chunk-7-1.pdf}
